...
class MyOrdersCardWidget extends StatefulWidget {
  final String title;
  final Color color;
  ...
  @override
  State<MyOrdersCardWidget> createState() => _MyOrdersCardWidgetState();
}

class _MyOrdersCardWidgetState extends State<MyOrdersCardWidget> {
  @override

...
class _CardWidgetState extends State<CardWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Row(
        children: [
         SvgPicture.asset(Assets.svg.uzcard.path, 
           width: 52.r,height: 52.r,fit: BoxFit.fill,),
          Column(
            children: [
              Text('8763 **** 0329', style: Theme.of(context).textTheme.bodySmall!.copyWith(
                fontSize: 16.sp,
              ...
              Row(
                children: [
                  Text('Sayfiyev Fayozjon', style: Theme.of(context).textTheme.bodySmall!.copyWith(
                    fontSize: 16.sp,
                    fontWeight: FontWeight.w500,
                    color: AppColor.greyColor2,
                  ),),
